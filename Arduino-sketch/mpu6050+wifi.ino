// mpu6050에 상보필터를 적용하고 wifi 통신 코드까지 삽입
// 2022. 08

#include <Wire.h> // I2C 통신을 이용하기 위한 헤더파일
#include <WiFi.h> // Wifi 통신을 이용하기 위한 헤더파일
#include <HTTPClient.h>
#define PI 3.141592653589

// 변수 정의 공간
const char* ssid = "aischool class06(2.4Ghz)"; // 와이파이 이름
const char* password =  "gjaischool";  // 와이파이 비밀번호
